...
public class NexttelCsvToXlsxMultiple {
    ...
    public NexttelCsvToXlsxMultiple(String folder, String dateRequisition, String demandeurRequisition) {
        this.folder = folder;
...
//        NexttelCsvToXlsx ctx = new NexttelCsvToXlsx("661000083", "");
//        ctx.generate();
    }
}
