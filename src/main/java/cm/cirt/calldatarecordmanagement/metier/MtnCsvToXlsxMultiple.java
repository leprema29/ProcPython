...
public class MtnCsvToXlsxMultiple {
    ...
    public MtnCsvToXlsxMultiple(String folder, String dateRequisition, String demandeurRequisition) {
        this.folder = folder;
...
//            sheet.autoSizeColumn(6);
    ...
    public void generate() {
        ...
        try {
            ...
            for (File file : files) {
                if (file.getName().startsWith("Requisition_IdNumero")) {
                    fileAbonne = file;
...
//        excelRow.createCell(6).setCellValue((String) csvRow.get(""));
    ...
    public void createExcelHeaderAbonne(Sheet sheet, int rowNo) {
        ...
        excelRow.createCell(3).setCellValue("CNI");
