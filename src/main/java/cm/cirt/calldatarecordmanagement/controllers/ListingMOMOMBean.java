...
import cm.cirt.calldatarecordmanagement.metier.MomoCsvToXlsx;
...
public class ListingMOMOMBean implements Serializable {
...
//        this.requisitionsManager.create(requisition);
        ...
        try {
            ...
            Logger.getLogger(ListingMOMOMBean.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (operateur.equals("Mtn")) {
            ...
            octx.generate();
        } else if (operateur.equals("MOMO")) {
            MomoCsvToXlsx octx = new MomoCsvToXlsx(this.goodPhone, df2.format(dateRequisition));
            octx.generate();
        }

        this.allFilesName = new ArrayList<>();
        this.allFilesName.add(this.goodPhone + "_MOMO.xlsx");
...
//        BigDecimal bd = new BigDecimal(secondes);
    ...
    public String getOperatorByTelephone(String tel) {
        ...
        if ((tel.startsWith("67")) || (tel.startsWith("650")) || (tel.startsWith("651")) || (tel.startsWith("652"))
                ...
                || (tel.startsWith("682")) || (tel.startsWith("683")) || (tel.startsWith("644"))) {
            op = "Mtn";
                ...
                || (tel.startsWith("687")) || (tel.startsWith("688")) || (tel.startsWith("649"))) {
            op = "Orange";
