...
//    String LOGO_PATH = "image" + System.getProperty("file.separator") + "Untitled.png";
    ...
    public Document PrintIDAbonneNEXTTEL(String number, Document document, String[] data) throws BadElementException, IOException {
        ...
        try {
            ...
            table.addCell(c2);
            table.addCell(MakeCellValueTableau(data[3] + " " + data[4]));
            ...
            c1.setHorizontalAlignment(Element.ALIGN_LEFT);
            table.addCell(c2);
            table.addCell(MakeCellValueTableau(data[8] + " du " + data[9] + " à " + data[11]));
...
//IdAbonne[0], IdAbonne[1] + " " +  IdAbonne[2], IdAbonne[3], IdAbonne[4], IdAbonne[5]
    ...
    public PdfPTable PrintAddStatsNEXTTEL(Document document, String[] data, PdfPTable table1, int i) throws BadElementException, IOException {
    ...
    public PdfPTable PrintAddStatsNEXTTELLieux(Document document, String[] data, PdfPTable table1, int i) throws BadElementException, IOException {
