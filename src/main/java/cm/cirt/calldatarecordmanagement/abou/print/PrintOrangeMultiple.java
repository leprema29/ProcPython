...
public class PrintOrangeMultiple {
...
//656026559|175677767|DEDEA AKI|1990-03-07|2022-06-04|EDEA-EDEA
            ...
            c1.setHorizontalAlignment(Element.ALIGN_LEFT);
            table.addCell(c2);
            table.addCell(MakeCellValueTableau(data[1]));
...
//            System.out.println("data[1]" + data[1]);
            ...
            c2.setHorizontalAlignment(Element.ALIGN_LEFT);
            table.addCell(c2);
            table.addCell(MakeCellValueTableau(data[5]));
...
//        18/07/2018 12:58:47,54,237695282679,693203710,,0000,352193096331790,237693203710,H-Paradis,Yaounde
        ...
        String location = data[5] + " " + data[6];
        String finalLocation = "Cell: " + data[4];
        if (!location.contains("null")) {
            finalLocation = location + " (Cell: " + data[4] + " Long: " + data[7] + " Lat: " + data[8] + " Azimut:-)";
        }
...
//237697812220 Chapelle-Manguier-IHS, Yaounde 352193096331790 23/07/2018 06:13:14 237693203710
        PdfPCell c2 = new PdfPCell();
        String location = data[6] + " " + data[7];
        String finalLocation = "Cell: " + data[5] ;
        if (!location.contains("null")) {
            finalLocation = location + " (Cell: " + data[5] + " Long: " + data[8] + " Lat: " + data[9] + " Azimut: -)";
        }
        table1.addCell(MakeCellRequi(data[4]));
        table1.addCell(MakeCellRequi(finalLocation));
        table1.addCell(MakeCellRequi(data[10]));
        table1.addCell(MakeCellRequi(data[0]));
        table1.addCell(MakeCellRequi(data[13]));
...
//656026559|175677767|DEDEA AKI|1990-03-07|2022-06-04|EDEA-EDEA
    ...
    public PdfPTable PrintAddFreqCelluleOrange(Document document, String[] data, PdfPTable table1, int i) throws BadElementException, IOException {
...
//        }
    ...
    public PdfPTable PrintAddFreqCorrespondantOrange(Document document, String[] data, PdfPTable table1, int i) throws BadElementException, IOException {
...
//        }
    ...
    public PdfPTable PrintAddFreqDureeAppelOrange(Document document, String[] data, PdfPTable table1, int i) throws BadElementException, IOException {
    ...
    public PdfPTable PrintAddFreqImeiOrange(Document document, String[] data, PdfPTable table1, int i) throws BadElementException, IOException {
    ...
    public PdfPTable PrintAddImeiPartageOrange(Document document, String[] data, PdfPTable table1) throws BadElementException, IOException {
