...
//            table1.setWidths(columnWidths);
    ...
    public PdfPTable PrintAddListingMTN(Document document, String[] data, PdfPTable table1) throws BadElementException, IOException {
        ...
        table1.addCell(MakeCellRequi(data[5] + ", " + data[6]));
    ...
    public PdfPTable PrintAddStatsMTN(Document document, String[] data, PdfPTable table1, int i) throws BadElementException, IOException {
    ...
    public PdfPTable PrintAddStatsMTNLieux(Document document, String[] data, PdfPTable table1, int i) throws BadElementException, IOException {
