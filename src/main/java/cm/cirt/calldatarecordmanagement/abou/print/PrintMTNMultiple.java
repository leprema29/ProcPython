...
//            table1.setWidths(columnWidths);
    ...
    public PdfPTable PrintAddListingMTN(Document document, String[] data, PdfPTable table1) throws BadElementException, IOException {
        ...
        String finalLocation = "Cell: " + data[1];
...
//       cell.setPadding(5);
        if (Variables111.ACCOUNT_TYPE.equals("SED")) {
            cell.setRowspan(3); // pour le SED et BIR
        } else if (Variables111.ACCOUNT_TYPE.equals("BIR")) {
            cell.setRowspan(3); // pour le SED et BIR
        } else {
            cell.setRowspan(4); // pour les autres
        }
//        cell.setRowspan(3); // pour le SED et BIR
...
//        table.addCell(MakeCellU("logo"));
        ...
        if ((!Variables111.ACCOUNT_TYPE.equals("SED")) && (!Variables111.ACCOUNT_TYPE.equals("BIR"))) {
